package com.example.customlibrary.storage;
...
public class StoragePreferences {
    ...
    private final static String FILE = "com.example.customlibrary.preferences";

    private final static String KEY_FOLDER_NAME = "shutt_app";
